...
#include "beeblebrox/authuserpassword.hpp"
#include "beeblebrox/httpresponse.hpp"
#include "beeblebrox/identifier.hpp"
#include "beeblebrox/uri.hpp"

#include "beeblebrox/httpcontent.hpp"
#include "beeblebrox/httpresponsefile.hpp"
...
class ZaphodHand : private codelithic::ThreadWrapper {
 ...
 private:
  ZaphodHand(const ZaphodHand& other) = delete;
  ZaphodHand(ZaphodHand&& other) noexcept(false) = delete;
