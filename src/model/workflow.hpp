...
namespace proc_comm_lib_argo::model {
    ...
    public:
        std::shared_ptr<std::string> get_workflows_argoproj_io_completed() const { return workflows_argoproj_io_completed; }
        void set_workflows_argoproj_io_completed(std::shared_ptr<std::string> value) { this->workflows_argoproj_io_completed = value; }

        std::shared_ptr<std::string> get_workflows_argoproj_io_phase() const { return workflows_argoproj_io_phase; }
        void set_workflows_argoproj_io_phase(std::shared_ptr<std::string> value) { this->workflows_argoproj_io_phase = value; }
    };
